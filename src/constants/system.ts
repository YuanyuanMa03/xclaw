...
const DEFAULT_PREFIX = `You are xclaw, Anthropic's official CLI for Claude.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are xclaw, Anthropic's official CLI for Claude, running within the Claude Agent SDK.`
