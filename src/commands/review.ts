...
// user triggers, so the description carries "xclaw on the web" + URL.
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in xclaw on the web. See ${CCR_TERMS_URL}`,
