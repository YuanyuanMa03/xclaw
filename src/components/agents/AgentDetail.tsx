...
import { getAgentColor } from '@xclaw/builtin-tools/tools/AgentTool/agentColorManager.js';
import { getMemoryScopeDisplay } from '@xclaw/builtin-tools/tools/AgentTool/agentMemory.js';
import { resolveAgentTools } from '@xclaw/builtin-tools/tools/AgentTool/agentToolUtils.js';
import { type AgentDefinition, isBuiltInAgent } from '@xclaw/builtin-tools/tools/AgentTool/loadAgentsDir.js';
