    ...
    <Pane>
      <Box flexDirection="column" gap={1}>
        ...
        <Box flexDirection="column" marginLeft={2}>
          <Text dimColor>
            {referrerReward
              ? `Share a free week of xclaw with friends. If they love it and subscribe, you'll get ${formatCreditAmount(referrerReward)} of extra usage to keep building. `
              : 'Share a free week of xclaw with friends. '}
            <Link
              url={
                referrerReward
