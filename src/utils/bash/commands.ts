...
# xclaw Code Bash command prefix detection

This document defines risk levels for actions that the xclaw agent may take. This classification system is part of a broader safety framework and is used to determine when additional user confirmation or oversight may be needed.
