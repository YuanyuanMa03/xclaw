...
export class TaskOutput {
  ...
  async #readStdoutFromFile(): Promise<string> {
    ...
    try {
      ...
      return `<bash output unavailable: output file ${this.path} could not be read (${code}). This usually means another xclaw process in the same project deleted it during startup cleanup.>`
    }
  }
