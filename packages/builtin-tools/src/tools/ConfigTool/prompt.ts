...
export const DESCRIPTION = 'Get or set xclaw configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set xclaw configuration settings.

  View or change xclaw settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
